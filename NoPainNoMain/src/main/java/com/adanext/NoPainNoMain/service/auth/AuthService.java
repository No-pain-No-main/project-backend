...
public class AuthService {
    ...
    public LoginResponse studentLogin(String documentNumber, String rawPassword) {
        ...
        return new LoginResponse(token, JwtParameters.ROLE_STUDENT, student.getDocumentNumber(), student.getFirstName(), student.getLastName());
    }
    ...
    public LoginResponse adminLogin(String documentNumber, String rawPassword) {
        ...
        return new LoginResponse(token, JwtParameters.ROLE_ADMIN, admin.getId(), admin.getFirstName(), admin.getLastName());
    }
