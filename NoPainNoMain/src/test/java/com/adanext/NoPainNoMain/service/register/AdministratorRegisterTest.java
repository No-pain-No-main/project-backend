...
class AdministratorRegisterTest {
    ...
    @Mock
    private JsonToClass<Administrator> jsonToClass;
    ...
    @InjectMocks
    private AdministratorRegister administratorRegister;

    private Administrator validAdmin;
    private final String validJson = "{\"documentNumber\":\"12345678\",\"email\":\"admin@nopainnomain.com\"}";
    ...
    void save_duplicateDocument_throwsIllegalStateException() {
        ...
        IllegalStateException ex = assertThrows(IllegalStateException.class, 
                () -> administratorRegister.save(validJson));
    ...
    void save_invalidJson_throwsExceptionWithoutCheckingBusinessRules() {
        ...
        assertThrows(IllegalArgumentException.class, 
                () -> administratorRegister.save(invalidJson));
