...
class AvailabilityServiceTest {
    ...
    @Mock
    private MachineRepositoryImpl machineRepository;
    ...
    void findFreeSlotsByMachine_whenAllSlotsBooked_returnsEmptyList() {
        Booking b1 = new Booking(); b1.setTimeSlot(slot1);
        Booking b2 = new Booking(); b2.setTimeSlot(slot2);
        Booking b3 = new Booking(); b3.setTimeSlot(slot3);
    ...
    @Test
    void findFreeSlotsByMachine_whenMultipleBookingsForSameSlot_returnsThatSlotOnlyOnceAsUnavailable() {
        Booking b1 = new Booking(); b1.setTimeSlot(slot1);
        Booking b2 = new Booking(); b2.setTimeSlot(slot1);
